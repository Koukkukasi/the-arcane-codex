...
async def test_overlays():
    async with async_playwright() as p:
        ...
        print("[OK] Captured Character overlay")
        ...
        print("[OK] Captured Inventory overlay")
        await page.keyboard.press('Escape')
        await page.wait_for_timeout(500)
        ...
        print("[OK] Captured Skills overlay")
        await page.keyboard.press('Escape')
        await page.wait_for_timeout(500)
        ...
        print("[OK] Captured Quests overlay")
        await page.keyboard.press('Escape')
        await page.wait_for_timeout(500)
        ...
        print("[OK] Captured Settings overlay")
        ...
        print("\n[SUCCESS] All overlays tested successfully!")
        print("[INFO] Screenshots saved in 'screenshots' folder")
